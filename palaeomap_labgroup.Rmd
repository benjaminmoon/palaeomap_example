...
* [X] Add exercises
  ...
  - [X] add other occurrences
  - [X] separate latitude with colours
  - [X] add exercise answers
* [X] Add RStudio images to introduction
* [X] GPlates export images
* [X] Revise to second person
* [ ] Proofread
